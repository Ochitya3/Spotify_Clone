  ...
  return (
    <div className="h-full w-full flex">
      ...
      <div className="h-full w-4/5 bg-app-black overflow-auto">
        <div className="navBar w-full h-1/10 bg-black bg-opacity-30 flex item-center justify-end">
          <div className="w-1/2 flex h-full">
            <div className="w-3/5 flex justify-around items-center">
              <TextWithHover displayText={"Premium"} targetLink={"/login"} />
              <TextWithHover displayText={"Support"} targetLink={"/login"} />
              <TextWithHover displayText={"Download"} targetLink={"/login"} />
        ...
        <div className="content p-8 pt-0 overflow-auto">
          ...
          <PlaylistView
            titleText="Popular Artist"
            cardsData={artistCardsData}
          />
